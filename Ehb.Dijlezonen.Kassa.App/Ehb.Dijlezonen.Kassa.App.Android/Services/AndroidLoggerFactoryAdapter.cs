...
namespace Ehb.Dijlezonen.Kassa.App.Droid.Services
{
    public class AndroidLoggerFactoryAdapter : AbstractSimpleLoggerFactoryAdapter
    {
        ...
        public AndroidLoggerFactoryAdapter(Common.Logging.Configuration.NameValueCollection properties) : base(properties)
        {
        }

        public AndroidLoggerFactoryAdapter(LogLevel level, bool showDateTime, bool showLogName, bool showLevel, string dateTimeFormat) : 
